...
const COLORS = ["#0d9488", "#3b82f6", "#8b5cf6", "#ec4899", "#f59e0b", "#10b981", "#ef4444", "#64748b"];
  ...
  return (
    ...
    >
      <div
        ...
        style={{ background: "var(--color-modal)", borderRadius: 16, width: "100%", maxWidth: 580, boxShadow: "0 20px 60px rgba(0,0,0,0.18)", overflow: "hidden", display: "flex", flexDirection: "column", maxHeight: "calc(100vh - 48px)" }}
      >
        {/* Header */}
              ...
              {draftProjects.map((p) => {
                ...
                return (
                  <div key={p.id} style={{ display: "flex", alignItems: "center", gap: 10, padding: "10px 14px", background: "var(--color-surface-raised)", border: "1px solid var(--color-border)", borderRadius: 10, marginTop: 8 }}>
                    <span style={{ width: 12, height: 12, borderRadius: "50%", background: p.color || "#0d9488", display: "inline-block", flexShrink: 0 }} />
